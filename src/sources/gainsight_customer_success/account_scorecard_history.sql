...
renamed AS (
  ...
  SELECT
    ...
    accelerators::INT                                           AS accelerators,
    kick_off_delivery::INT                                      AS kick_off_delivery,
    ebrs_completed::INT                                         AS ebrs_completed,
    workshops_completed::INT                                    AS workshops_completed,
    completeness::INT                                           AS completeness,
    verifiable_outcomes_delivered::INT                          AS verifiable_outcomes_delivered,
    verifiable_outcomes_defined::INT                            AS verifiable_outcomes_defined,
