...
joined AS (
  ...
  SELECT
    ...
    fct_ping_instance.duo_amazon_q_purchased_seats                                                          AS duo_amazon_q_purchased_seats,
    fct_ping_instance.duo_amazon_q_assigned_seats                                                           AS duo_amazon_q_assigned_seats,
    ...
    dim_ping_instance.ping_created_date_week                                                                AS ping_created_date_week,
