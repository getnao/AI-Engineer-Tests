...
final AS (
  ...
  SELECT
    ...
    --Product Activity
    fct_crm_account.core_score,
    fct_crm_account.usage_data_last_updated_date,
    fct_crm_account.first_ping_date,
    fct_crm_account.last_ping_date,
    fct_crm_account.gitlab_version,
    fct_crm_account.monthly_active_users,
    fct_crm_account.devops_score,
    fct_crm_account.collaboration_score,
    fct_crm_account.security_score,
    fct_crm_account.total_activity_score,
    dim_crm_account.activity_level,
    dim_crm_account.match_confidence,
    dim_crm_account.gitlab_edition,
    dim_crm_account.product_usage_summary,
    dim_crm_account.notable_product_usage_detail,
    fct_crm_account.ptp_scores,
    dim_crm_account.host_name,
    dim_crm_account.ptp_insight,
