...
{{ simple_cte([
    ...
    ('instance_type_ordering', 'dim_host_instance_type')
...
, sm_subscriptions AS (
    ...
    SELECT
      ...
      ping_instance_wave_sm.major_minor_version_num,
    ...
    QUALIFY ROW_NUMBER() OVER (
      PARTITION BY
        ...
        ORDER BY
          ...
          instance_type_ordering.instance_type_ordering_field ASC --prioritizing Production instances
    ) = 1
