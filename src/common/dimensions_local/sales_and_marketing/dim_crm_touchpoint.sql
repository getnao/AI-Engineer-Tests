...
combined_touchpoints AS (
  ...
  SELECT
    ...
    NULL                                                                          AS dim_crm_buyer_touchpoint_id,
    -- touchpoint info
  ...
  SELECT
    ...
    bizible_marketing_channel,
    IFF(bizible_ad_campaign_name = '20201013_ActualTechMedia_DeepMonitoringCI', 'Sponsorship', bizible_marketing_channel_path) AS bizible_marketing_channel_path,
    bizible_medium,
    bizible_referrer_page,
    bizible_referrer_page_raw,
    bizible_salesforce_campaign,
...
final AS (
  ...
  SELECT
    ...
    combined_touchpoints.dim_crm_buyer_touchpoint_id,
    ...
    COALESCE (devrel_influence_campaigns.campaign_name IS NOT NULL, FALSE) AS is_devrel_influenced_campaign,
