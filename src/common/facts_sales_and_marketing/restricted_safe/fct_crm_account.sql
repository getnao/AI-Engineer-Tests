WITH final AS (
    ...
    SELECT 
      ...
      prep_crm_account.core_score, 
      prep_crm_account.usage_data_last_updated_date,
      prep_crm_account.first_ping_date,
      prep_crm_account.last_ping_date,
      prep_crm_account.gitlab_version,
      prep_crm_account.monthly_active_users,
      prep_crm_account.devops_score,
      prep_crm_account.collaboration_score,
      prep_crm_account.security_score,
      prep_crm_account.total_activity_score,
      prep_crm_account.ptp_scores,
