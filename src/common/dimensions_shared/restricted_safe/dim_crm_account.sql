...
final AS (
  ...
  SELECT
    ...
    --Product Activity
    prep_crm_account.activity_level,
    prep_crm_account.match_confidence,
    prep_crm_account.gitlab_edition,
    prep_crm_account.product_usage_summary,
    prep_crm_account.notable_product_usage_detail,
    prep_crm_account.host_name,
    prep_crm_account.ptp_insight,
