...
{{ simple_cte([
    ...
    ('map_person_title_to_persona_group', 'map_person_title_to_persona_group'),
...
, final AS (
    ...
    SELECT
      ...
      dim_crm_person.is_no_longer_at_company,
      ...
      map_person_title_to_persona_group.persona_category,
      map_person_title_to_persona_group.is_management,
    ...
    LEFT JOIN map_person_title_to_persona_group
      ON fct_crm_person.dim_crm_person_id = map_person_title_to_persona_group.dim_crm_person_id
