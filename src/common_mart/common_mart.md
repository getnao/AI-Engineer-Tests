...
- Include events from the following app_ids: `gitlab_ai_gateway`, `gitlab_ide_extension`, `gitlab_ide_extension_sm`, and `gitlab_ide_extension_dedicated`
    - The `gitlab_ai_gateway` app_id does not have different suffixes for different deployment types
