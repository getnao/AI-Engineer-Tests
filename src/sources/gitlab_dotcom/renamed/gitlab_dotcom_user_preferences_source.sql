...
renamed AS (
  ...
  SELECT
    ...
    text_editor_type::NUMBER                  AS text_editor_type,
    merge_request_dashboard_list_type::NUMBER AS merge_request_dashboard_list_type,
    keyboard_shortcuts_enabled::BOOLEAN       AS keyboard_shortcuts_enabled
  FROM source
