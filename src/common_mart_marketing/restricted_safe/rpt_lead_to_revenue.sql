...
, mart_crm_person_with_tp AS (
  ...
  --Touchpoint Data
      'Buyer Touchpoint' AS touchpoint_type,
  ...
  --Touchpoint Data
      CASE
        WHEN mart_crm_person_with_tp.touchpoint_type = 'Buyer Touchpoint'
          THEN 'Buyer Touchpoint'
        WHEN opp_base_with_batp.touchpoint_type = 'Attribution Touchpoint'
          THEN 'Attribution Touchpoint'
