...
snapshot_dates AS (
  ...
  SELECT DISTINCT
    first_day_of_month,
    CASE 
      WHEN first_day_of_month < '2024-03-01' THEN snapshot_date_fpa         -- 8th day until March 2024
      WHEN first_day_of_month < '2025-05-01' THEN snapshot_date_fpa_fifth   -- 5th day from March to April 2025
      ELSE snapshot_date_fpa_fourth                                         -- 4th day from May 2025 onwards
