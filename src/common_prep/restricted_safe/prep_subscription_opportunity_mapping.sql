WITH zuora_account_source AS (
    ...
    INNER JOIN {{ ref('fct_crm_opportunity', v=2) }} AS fct_opp
      ON ii.invoice_number = fct_opp.invoice_number
    INNER JOIN {{ ref('dim_crm_opportunity', v=2) }} AS opp
      ON fct_opp.dim_crm_opportunity_id = opp.dim_crm_opportunity_id
    WHERE fct_opp.stage_name <> '10-Duplicate'
