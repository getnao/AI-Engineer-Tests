...
listing AS (
  ...
  SELECT
    ...
    IFF(listing_stage.job_title = 'Code2College Intern'
      AND listing_stage.date_actual < '2022-06-16','Intern (Trainee)',staff_hist.employee_type_current)          AS employee_type,
