...
-- scm metrics --
        ...
        CASE WHEN git_operation_utilization IS NULL THEN NULL
            ...
            WHEN git_operation_utilization > .33 THEN 88 end AS scm_score,
...
-- old ci metrics --
        ...
        CASE WHEN old_ci_score IS NULL THEN NULL
            ...
            WHEN old_ci_score = 88 THEN 'Green' end AS old_ci_color,
...
-- ci lighthouse metrics --
        ...
        CASE WHEN ci_builds_per_billable_user IS NULL THEN NULL
             ...
             WHEN ci_builds_per_billable_user > 40 THEN 88 END AS ci_builds_per_billable_user_score, 
