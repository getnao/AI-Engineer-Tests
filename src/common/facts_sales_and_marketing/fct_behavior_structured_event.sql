...
structured_events_w_dim AS (
    ...
    SELECT
      ...
      events_with_plan.deployment_type,
      events_with_plan.unique_instance_id,
      events_with_plan.host_name,
      events_with_plan.dim_plan_id,
      events_with_plan.dim_ultimate_parent_namespace_id,
      events_with_plan.user_type,
      ...
      events_with_plan.resolution_strategies,
