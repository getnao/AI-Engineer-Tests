...
, final AS (
  ...
  SELECT
    ...
    -- Additional relationship keys
    fct_crm_task.lead_or_contact_id,
    fct_crm_task.account_or_opportunity_id,
    ...
    -- Gong-related fields
    dim_crm_task.gong_associated_accounts,
    dim_crm_task.gong_associated_opportunities,
