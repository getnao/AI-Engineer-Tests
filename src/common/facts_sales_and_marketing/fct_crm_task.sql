...
-- This CTE is pulling the most recent sfdc_record_id and dim_crm_person_id of a record so that they correspond to the values in the mart_crm_person model.
  ...
  SELECT
    ...
    {{ get_keyed_nulls('prep_crm_task.lead_or_contact_id') }}        AS lead_or_contact_id,
    {{ get_keyed_nulls('prep_crm_task.account_or_opportunity_id') }} AS account_or_opportunity_id,
