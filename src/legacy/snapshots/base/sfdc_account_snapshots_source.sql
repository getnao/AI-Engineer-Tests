...
renamed AS (
  ...
  SELECT
    ...
    --Product Activity
    number_of_active_namespace__c                                                     AS core_score,
    last_updated_date_usage_data__c                                                   AS usage_data_last_updated_date,
    first_ping__c                                                                     AS first_ping_date,
    last_ping__c                                                                      AS last_ping_date,
    number_of_active_stages_in_company__c                                             AS gitlab_version,
    number_of_active_users_in_company__c                                              AS monthly_active_users,
    num_active_namespace_exceeding_storage__c                                         AS devops_score,
    git_operation_users__c                                                            AS collaboration_score,
    account_count__c                                                                  AS security_score,
    ci_builds_count_all_time__c                                                       AS total_activity_score,
    activity_level__c                                                                 AS activity_level,
    match_confidence__c                                                               AS match_confidence,
    gitlab_edition__c                                                                 AS gitlab_edition,
    list_of_shared_accounts__c                                                        AS product_usage_summary,
    list_of_namespaces__c                                                             AS notable_product_usage_detail,
    total_billable_users__c                                                           AS ptp_scores,
    host_name__c                                                                      AS host_name,
    ptp_insight__c                                                                    AS ptp_insight,
    ...
    -- ************************************
    -- NF: 2020-12-17
    -- these fields are used to identify accounts owned by
