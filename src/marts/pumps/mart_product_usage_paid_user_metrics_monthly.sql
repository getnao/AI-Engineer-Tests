...
{{ simple_cte([
    ...
    ('addon_license_billable_users', 'rpt_license_billable_users_daily')
...
, most_recent_subscription_version AS (
    ...
    SELECT
      ...
      monthly_sm_metrics.major_minor_version_num,
      ...
      addon_license_billable_users.is_duo_core_features_enabled                       AS is_duo_core_features_enabled,
      addon_license_billable_users.duo_amazon_q_license_users_coalesced               AS duo_amazon_q_license_user_count,
      addon_license_billable_users.duo_amazon_q_billable_users_coalesced              AS duo_amazon_q_billable_user_count,
      -- Wave 2 & 3
    ...
    SELECT
      ...
      NULL                                                                          AS major_minor_version_num,
