...
, map_ip_location AS (
    ...
    SELECT
      ...
      add_country_info_to_usage_ping.ping_deployment_type                                AS product_deployment_type,
      ...
      add_country_info_to_usage_ping.duo_amazon_q_purchased_seats                        AS duo_amazon_q_purchased_seats,
      add_country_info_to_usage_ping.duo_amazon_q_assigned_seats                         AS duo_amazon_q_assigned_seats,
      add_country_info_to_usage_ping.is_duo_core_features_enabled                        AS is_duo_core_features_enabled,
      add_country_info_to_usage_ping.product_tier                                        AS product_tier,
      add_country_info_to_usage_ping.main_edition                                        AS main_edition,
      add_country_info_to_usage_ping.dim_subscription_id                                 AS dim_subscription_id,
      add_country_info_to_usage_ping.dim_license_id                                      AS dim_license_id
    ...
    SELECT
      ...
      prep_usage_ping_cte.dim_subscription_id                                                             AS dim_subscription_id,
      ...
      prep_usage_ping_cte.dim_license_id                                                                  AS dim_license_id,
      ...
      prep_usage_ping_cte.product_deployment_type                                                         AS product_deployment_type,
      ...
      prep_usage_ping_cte.duo_amazon_q_purchased_seats                                                    AS duo_amazon_q_purchased_seats,
      prep_usage_ping_cte.duo_amazon_q_assigned_seats                                                     AS duo_amazon_q_assigned_seats,
      prep_usage_ping_cte.is_duo_core_features_enabled                                                    AS is_duo_core_features_enabled,
    ...
    SELECT
      ...
      prep_usage_ping_and_license.product_deployment_type                                                    AS product_deployment_type,
      ...
      prep_usage_ping_and_license.duo_amazon_q_purchased_seats                                               AS duo_amazon_q_purchased_seats,
      prep_usage_ping_and_license.duo_amazon_q_assigned_seats                                                AS duo_amazon_q_assigned_seats,
      prep_usage_ping_and_license.is_duo_core_features_enabled                                               AS is_duo_core_features_enabled,
