...
final AS (
  ...
  SELECT
    ...
    SUM(first_order_open_1plus_saos_in_snapshot_quarter)               AS first_order_open_1plus_saos_in_snapshot_quarter,
    SUM(first_order_open_3plus_saos_in_snapshot_quarter)               AS first_order_open_3plus_saos_in_snapshot_quarter,
    SUM(first_order_open_4plus_saos_in_snapshot_quarter)               AS first_order_open_4plus_saos_in_snapshot_quarter,
    ...
    SUM(first_order_open_1plus_pipeline_in_snapshot_quarter)           AS first_order_open_1plus_pipeline_in_snapshot_quarter,
    SUM(first_order_open_3plus_pipeline_in_snapshot_quarter)           AS first_order_open_3plus_pipeline_in_snapshot_quarter,
    SUM(first_order_open_4plus_pipeline_in_snapshot_quarter)           AS first_order_open_4plus_pipeline_in_snapshot_quarter,
    SUM(first_order_pipeline_generated_in_snapshot_quarter)            AS first_order_pipeline_generated_in_snapshot_quarter,
    SUM(first_order_bookings_in_snapshot_quarter)                      AS first_order_bookings_in_snapshot_quarter,
    SUM(first_order_closed_deals_in_snapshot_quarter)                  AS first_order_closed_deals_in_snapshot_quarter,
    SUM(first_order_closed_opps_in_snapshot_quarter)                   AS first_order_closed_opps_in_snapshot_quarter,
    SUM(first_order_closed_won_opps_in_snapshot_quarter)               AS first_order_closed_won_opps_in_snapshot_quarter,
    SUM(first_order_closed_net_arr_in_snapshot_quarter)                AS first_order_closed_net_arr_in_snapshot_quarter,
    ...
    SUM(first_order_open_1plus_saos)                                   AS first_order_open_1plus_saos,
    SUM(first_order_open_3plus_saos)                                   AS first_order_open_3plus_saos,
    SUM(first_order_open_4plus_saos)                                   AS first_order_open_4plus_saos,
    SUM(first_order_saos_generated)                                    AS first_order_saos_generated,
    SUM(first_order_booked_deals)                                      AS first_order_booked_deals,
    SUM(first_order_open_1plus_pipeline)                               AS first_order_open_1plus_pipeline,
    SUM(first_order_open_3plus_pipeline)                               AS first_order_open_3plus_pipeline,
    SUM(first_order_open_4plus_pipeline)                               AS first_order_open_4plus_pipeline,
    SUM(first_order_pipeline_generated)                                AS first_order_pipeline_generated,
    SUM(first_order_bookings)                                          AS first_order_bookings,
    SUM(first_order_closed_deals)                                      AS first_order_closed_deals,
    SUM(first_order_closed_opps)                                       AS first_order_closed_opps,
    SUM(first_order_closed_won_opps)                                   AS first_order_closed_won_opps,
    SUM(first_order_closed_net_arr)                                    AS first_order_closed_net_arr
  FROM actuals
  GROUP BY ALL
