...
, first_order_key AS (
  ...
  SELECT
    ...
    dim_order_type_id,
    dim_sales_qualified_source_id_simplified      AS dim_sales_qualified_source_id,
  ...
  INNER JOIN dim_crm_opportunity_flags
    ON fct_crm_opportunity.dim_crm_opportunity_flags_sk = dim_crm_opportunity_flags.dim_crm_opportunity_flags_sk
  WHERE dim_crm_opportunity_flags.is_new_logo_first_order = TRUE
  ...
  INNER JOIN dim_crm_opportunity_flags
    ON fct_crm_opportunity.dim_crm_opportunity_flags_sk = dim_crm_opportunity_flags.dim_crm_opportunity_flags_sk
  WHERE dim_crm_opportunity_flags.is_sao = TRUE
...
SELECT
  {{ dbt_utils.generate_surrogate_key([
      ...
      'metrics.dim_crm_person_id']) }}                                      AS sales_funnel_actual_sk,
