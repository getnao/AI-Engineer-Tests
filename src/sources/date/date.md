...
{% docs date_snapshot_date_fpa_fourth %}
4th calendar day of a month used for FP&A snapshots
{% enddocs %}
...
{% docs current_days_in_fiscal_quarter_count %}

This gives the number of days in the current fiscal quarter. For example if the current fiscal quarter were FY26-Q2 then this would be 92 for all rows.  
