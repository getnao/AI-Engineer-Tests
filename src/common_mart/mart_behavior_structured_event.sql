...
report AS (
  SELECT
    ...
    installation.dim_installation_id,
    structured_behavior.deployment_type,
    ...
    structured_behavior.unique_instance_id,
    ...
    structured_behavior.input_tokens,
    structured_behavior.output_tokens,
    structured_behavior.total_tokens,
    structured_behavior.model_engine,
    structured_behavior.model_name,
    structured_behavior.model_provider,
    structured_behavior.feature_enablement_type,
    structured_behavior.user_type,
  ...
  LEFT JOIN namespace
    ON structured_behavior.dim_namespace_id = namespace.dim_namespace_id
      AND structured_behavior.deployment_type = 'GitLab.com'
  LEFT JOIN project
  ...
  LEFT JOIN installation
    ON structured_behavior.dim_instance_id = installation.dim_instance_id
      AND structured_behavior.host_name = installation.host_name
)
