...
py_arr_with_cy_parent AS (
  ...
  LEFT JOIN dim_crm_account_daily_snapshot
    ...
    AND dim_crm_account_daily_snapshot.snapshot_date = CASE WHEN delta_arr_month < '2024-03-01'
                                                            ...
                                                            WHEN delta_arr_month < '2025-05-01'
                                                            THEN DATEADD('month', 3, snapshot_date_fpa_fifth)
                                                            ELSE DATEADD('month', 3, snapshot_date_fpa_fourth) 
                                                            END
  -- join logic for the switch between 8th and 5th day snapshot from 2024-03-01 and 5th and 4th day snapshot from 2025-05-01 
