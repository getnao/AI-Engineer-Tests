...
, duo_aggregates AS (
  ...
  SELECT
    ...
    SUM(duo_amazon_q_license_user_count)                                                   AS account_level_duo_amazon_q_license_user_count,
    SUM(duo_amazon_q_billable_user_count)                                                  AS account_level_duo_amazon_q_billable_user_count,
    DIV0(SUM(duo_pro_billable_user_count), SUM(duo_pro_license_user_count))                AS account_level_duo_pro_license_utilization,
    DIV0(SUM(duo_enterprise_billable_user_count), SUM(duo_enterprise_license_user_count))  AS account_level_duo_enterprise_license_utilization,
    DIV0(SUM(duo_amazon_q_billable_user_count), SUM(duo_amazon_q_license_user_count))      AS account_level_duo_amazon_q_license_utilization,
    ...
    DIV0(SUM(duo_total_billable_user_count), SUM(duo_total_license_user_count))            AS account_level_duo_total_license_utilization
  ...
  SELECT DISTINCT
    ...
    duo_aggregates.account_level_duo_amazon_q_license_user_count,
    duo_aggregates.account_level_duo_amazon_q_billable_user_count,
    duo_aggregates.account_level_duo_pro_license_utilization,
    duo_aggregates.account_level_duo_enterprise_license_utilization,
    duo_aggregates.account_level_duo_amazon_q_license_utilization,
  FROM rpt_product_usage_health_score_account_calcs
