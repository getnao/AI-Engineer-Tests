...
WITH product_details AS (
  ...
  SELECT
    ...
    CASE 
      ...
      WHEN add_on_type_original = 'duo_amazon_q'
        THEN 'GitLab Duo with Amazon Q'
      WHEN add_on_type_original = 'duo_core'
        THEN 'GitLab Duo Core'
      WHEN add_on_type_original = 'duo_nano'
        THEN 'GitLab Duo Core'
  ...
  SELECT
    ...
    IFF(add_on_type = 'GitLab Duo Pro', addon_purchased_seats, NULL)            AS duo_pro_license_users,
    IFF(add_on_type = 'GitLab Duo Pro', addon_assigned_seats, NULL)             AS duo_pro_billable_users,
    IFF(add_on_type = 'GitLab Duo Enterprise', addon_purchased_seats, NULL)     AS duo_enterprise_license_users,
    IFF(add_on_type = 'GitLab Duo Enterprise', addon_assigned_seats, NULL)      AS duo_enterprise_billable_users,
    IFF(add_on_type = 'GitLab Duo with Amazon Q', addon_purchased_seats, NULL)  AS duo_amazon_q_license_users,
    /*
    ...
    */
    IFF(add_on_type = 'GitLab Duo with Amazon Q', active_user_count, NULL)      AS duo_amazon_q_billable_users,
