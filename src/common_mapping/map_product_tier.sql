    ...
    SELECT
      ...
      CASE
        ...
        WHEN LOWER(zuora_product_rate_plan.product_rate_plan_name) LIKE '%saas - premium%'
          THEN 'SaaS - Premium'
        WHEN LOWER(zuora_product_rate_plan.product_rate_plan_name) LIKE ANY ('%dedicated - ultimate%', 'dedicated - gitlab duo with amazon q%')
          THEN 'Dedicated - Ultimate'        
        WHEN LOWER(zuora_product_rate_plan.product_rate_plan_name) LIKE ANY ('%ultimate%', 'self-managed - gitlab duo with amazon q%')
