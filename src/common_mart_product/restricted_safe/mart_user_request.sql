...
, opportunity_seats AS (
    ...
    SELECT
      ...
      fct_crm_opportunity.stage_name                                              AS crm_opp_stage_name,
      dim_crm_opportunity_flags.is_closed                                         AS crm_opp_is_closed,
      ...
      IFF(DATE_TRUNC('month', subscription_end_date.date_actual) >= DATE_TRUNC('month', CURRENT_DATE),
        DATE_TRUNC('month', subscription_end_date.date_actual),
        NULL
