WITH live_actuals AS (
  ...
  SELECT 
    ...
    created_arr,
    created_deals,
    first_order_pipeline_generated,
    first_order_bookings,
    first_order_saos_generated,
    first_order_booked_deals,
    first_order_closed_deals,
    first_order_closed_opps,
    first_order_closed_won_opps,
    first_order_closed_net_arr
...
booked_arr AS (
  ...
  SELECT
    ...
    SUM(live_actuals.first_order_bookings) AS total_first_order_bookings,
    SUM(live_actuals.first_order_booked_deals) AS total_first_order_booked_deals,
    SUM(live_actuals.first_order_closed_deals) AS total_first_order_closed_deals,
    SUM(live_actuals.first_order_closed_opps) AS total_first_order_closed_opps,
    SUM(live_actuals.first_order_closed_won_opps) AS total_first_order_closed_won_opps,
    SUM(live_actuals.first_order_closed_net_arr) AS total_first_order_closed_net_arr
  FROM live_actuals
...
created_arr AS (
  ...
  SELECT
    ...
    SUM(live_actuals.first_order_pipeline_generated) AS total_first_order_pipeline_generated,
...
final AS (
  ...
  SELECT
    ...
    booked_arr.total_first_order_bookings                                          AS first_order_bookings_in_snapshot_quarter,
    booked_arr.total_first_order_booked_deals                                      AS first_order_booked_deals_in_snapshot_quarter,
    booked_arr.total_first_order_closed_deals                                      AS first_order_closed_deals_in_snapshot_quarter,
    booked_arr.total_first_order_closed_opps                                       AS first_order_closed_opps_in_snapshot_quarter,
    booked_arr.total_first_order_closed_won_opps                                   AS first_order_closed_won_opps_in_snapshot_quarter,
    booked_arr.total_first_order_closed_net_arr                                    AS first_order_closed_net_arr_in_snapshot_quarter,
    created_arr.total_first_order_pipeline_generated                               AS first_order_pipeline_generated_in_snapshot_quarter,
    created_arr.total_first_order_saos_generated                                   AS first_order_saos_generated_in_snapshot_quarter
  FROM base
